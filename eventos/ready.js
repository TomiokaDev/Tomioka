   ...
   try {
      ...
      Promise.all(promises).then(results => {
         ...
         setInterval(function () {
            var estados = [`tk!help |v1.0.3| Estoy en ${guilds} servers.`, `tk!help |v1.0.3| Veo ${users} usuarios.`, `tk!report por algun fallo o sugerencia.`, `tk!invite |v1.0.3| Estoy en ${guilds} servers.`, `tk!invite |v1.0.3| Veo ${users} usuarios.`]
